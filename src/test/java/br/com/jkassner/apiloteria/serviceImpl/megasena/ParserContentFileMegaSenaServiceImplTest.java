...
public class ParserContentFileMegaSenaServiceImplTest {

    @Spy @InjectMocks
    ParserContentFileMegaSenaServiceImpl serviceImpl;

    @Mock
    ConcursoMegaSenaRepository megaSenaRepository;
    ...
    public void teste_counter_numero_vezes_save_concurso() throws IOException {
        ...
        when(megaSenaRepository.save(anyObject())).thenReturn(null);

        serviceImpl.populaResultados();

        verify(megaSenaRepository, times(2315)).save(anyObject());
    }


    private String parserHtmlToString() throws IOException {
        DefaultResourceLoader defaultResourceLoader = new DefaultResourceLoader();
        Resource resource = defaultResourceLoader.getResource("megasena/megasena.html");
